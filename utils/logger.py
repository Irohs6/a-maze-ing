...
# utilisé par toutes les couches du projet pour tracer les erreurs et avertissements.
# Responsabilités :
#   - créer le fichier de log dans logs/maze_errors.txt s'il n'existe pas
#   - formatter les entrées avec horodatage, niveau (ERROR/WARNING/INFO) et message
#   - écrire simultanément dans le fichier de log ET dans la sortie console (stderr)
