...
class Algorithm(ABC):
    ...
    def __init__(self, maze: Maze, is_perfect: bool) -> None:
        """Initialize the algorithm with a maze and a perfectness flag."""
        self.maze = maze
    ...
    def _is_42_wall(self, x: int, y: int, wall_direction: str) -> bool:
        """Return True if the wall borders a 42-pattern cell."""
        if (
    ...
    def _get_breakable_walls(self) -> list[tuple[int, int, str]]:
        """Return walls that can be removed to create an imperfect maze."""
