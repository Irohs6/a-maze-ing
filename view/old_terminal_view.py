...
if __name__ == "__main__":
    ...
    maze = Maze(20, 20)
    generator = MazeGenerator(maze.width, maze.height, seed=42, perfect=False)
    generator.generate()
    ...
    print("\033c", end="")  # cacher le curseur
    ...
    for x, y, direction in track:
        ...
        if direction == 'N':
            sys.stdout.write(f"\033[{screen_row - 1};{screen_col + 1}H  ")
        elif direction == 'S':
            sys.stdout.write(f"\033[{screen_row + 1};{screen_col + 1}H  ")
        elif direction == 'E':
            sys.stdout.write(f"\033[{screen_row};{screen_col + 3}H ")
        elif direction == 'W':
            sys.stdout.write(f"\033[{screen_row};{screen_col}H ")
        sys.stdout.write(f"\033[{screen_row};{screen_col}H{Fore.GREEN}●{Style.RESET_ALL}")
        sys.stdout.flush()
        sys.stdout.write(f"\033[{screen_row};{screen_col}H ")

    sys.stdout.write(f"\033[{2 * height + 2};1H")
