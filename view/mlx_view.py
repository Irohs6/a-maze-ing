...
#   - afficher/masquer le chemin solution (touche S)
#   - changer la couleur des murs (touches fléchées ou palette)
#   - optionnellement colorer le motif "42" différemment
# Peut inclure une animation de génération pas-à-pas (bonus).
